...
HEAD We will now add a new binary variable where if the outcome is benign = 0 and if it is malignant = 1
...
Biopsy_Data_with_PCAcomponents |>
  ...
  scale_color_manual( values = c(malignant = "purple", benign = "darkblue")) # Correct closing parenthesis
```
